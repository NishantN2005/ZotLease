<template>
    <div
      ...
      class="absolute top-20 left-1/2 transform -translate-x-1/2 bg-white w-80 shadow-lg rounded-md border border-gray-300 p-6 z-50"
    >
      <h1 class="font-bold text-xl text-center mb-4">Filter by:</h1>
      ...
      <form class="space-y-4" @submit.prevent="applyFilters">
        ...
        <button
          type="submit"
          class="w-full py-2 rounded bg-blue-600 text-white font-semibold hover:bg-blue-700"
        >
          Apply Filters
        </button>
